...
class KCFtracker(object):
    def __init__(self, max_patch_size=256, padding=2.5, sigma=0.6, lambdar=0.0001, update_rate=0.012, gray_feature=False, debug=False):
